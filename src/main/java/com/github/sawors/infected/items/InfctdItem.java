...
import com.github.sawors.infected.Infected;
...
public abstract class InfctdItem {
    Component name;
    ...
    public InfctdItem(String variant){
        this();
    ...
    public ItemStack get(){
        ...
        meta.getPersistentDataContainer().set(getItemIdKey(), PersistentDataType.STRING, id.toLowerCase(Locale.ROOT));
        ...
        meta.getPersistentDataContainer().set(getItemTagsKey(), PersistentDataType.STRING, typeskey.toString().toLowerCase(Locale.ROOT));
    ...
    public String getPersistentDataPrint(){
        ...
        printed
                .append("Item ID : ").append(container.get(getItemIdKey(), PersistentDataType.STRING))
                .append("\n")
                .append("Item Tags : ").append("[")
        ;
        String typestr = container.get(getItemTagsKey(), PersistentDataType.STRING);
        if(typestr != null){
            if(typestr.contains(":")){
    ...
    public static NamespacedKey getItemIdKey(){
        return new NamespacedKey((Infected.getPlugin(Infected.class)), "id");
    }
    
    public static NamespacedKey getItemTagsKey(){
        return new NamespacedKey((Infected.getPlugin(Infected.class)), "tags");
    }
    
    public static NamespacedKey getItemVariantKey(){
        return new NamespacedKey((Infected.getPlugin(Infected.class)), "variant");
    }
